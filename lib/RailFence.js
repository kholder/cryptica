...
(function() {
  ...
  module.exports = RailFence = (function() {
    ...
    RailFence.prototype.encode = function(message, rails, offset) {
    ...
    RailFence.prototype.decode = function(cipher, rails, offset) {
    ...
    _drawZigZag = function() {
      ...
      fence = _buildEmptyFence(this.rails, plain.length);
      forward = true;
      row = this.offset;
